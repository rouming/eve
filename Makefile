...
QEMU_OPTS_amd64=-smbios type=1,serial=romanroman
QEMU_OPTS_arm64=-smbios type=1,serial=romanroman -drive file=fat:rw:$(dir $(DEVICETREE_DTB)),label=QEMU_DTB,format=vvfat
