...
QEMU_OPTS_amd64=-smbios type=1,serial=romanpen
QEMU_OPTS_arm64=-smbios type=1,serial=romanpen -drive file=fat:rw:$(dir $(DEVICETREE_DTB)),label=QEMU_DTB,format=vvfat
